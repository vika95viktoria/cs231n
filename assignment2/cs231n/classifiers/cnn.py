...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params['W2'] = np.random.randn(num_filters * int(input_dim[1] / 2) * int(input_dim[1] / 2), hidden_dim) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        dx, dw3, db3 = affine_backward(dx, cache5)
        dx, dw2, db2 = affine_relu_backward(dx, cache4)
